...
- 2026-05-24: Variable-length fused CFG is owned by `l2p_model.py` batch-padding masks. Cross-sample `pad_sequence` padding is masked in the context refiner and main layers; internal `_SEQ_MULTI_OF` padding remains a native L2P token stream detail.
