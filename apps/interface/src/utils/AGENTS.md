...
- 2026-05-17: `engine_taxonomy.ts` accepts backend semantic id `qwen_image` from `/api/engines/capabilities` but intentionally maps it to no UI tab family until the Qwen Image frontend tab/request contract is implemented.
